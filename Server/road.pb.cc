...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\030\002 \001(\002\022\t\n\001z\030\003 \001(\002\022.\n\nclientTime\030\004 \001(\0132\032."
      "google.protobuf.Timestamp\"W\n\rPositionRep"
      "ly\022\013\n\003pos\030\001 \001(\t\022\026\n\016actuationForce\030\002 \001(\002\022"
      "\r\n\005dTime\030\003 \001(\003\022\022\n\nserverTime\030\004 \001(\t2>\n\010Po"
      "sition\0222\n\014SendPosition\022\020.PositionRequest"
      "\032\016.PositionReply\"\000b\006proto3"
  };
...
void PositionRequest::SharedCtor() {
  ::memset(&clienttime_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&clienttime_)) + sizeof(z_));
}
...
void PositionRequest::SerializeWithCachedSizes(
  ...
  if (this->has_clienttime()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->_internal_clienttime(), output);
  }
  ...
  if (this->has_clienttime()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, this->_internal_clienttime(), deterministic, target);
  }
